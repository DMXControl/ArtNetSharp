...
//        private IReadOnlyCollection<RemoteClientPort>? rcRXPort()
//        {
//            return instanceTX?.RemoteClients?.FirstOrDefault(rc => (rc.Root?.OemCode.Equals(instanceRX.OEMProductCode) ?? false) && rc.Root?.ManufacturerCode == instanceRX.ESTAManufacturerCode)?.Ports;
//        }
//        private IReadOnlyCollection<RemoteClientPort>? rcTXPort()
//        {
//            return instanceTX?.RemoteClients?.FirstOrDefault(rc => (rc.Root?.OemCode.Equals(instanceTX.OEMProductCode) ?? false) && rc.Root?.ManufacturerCode == instanceTX.ESTAManufacturerCode)?.Ports;
//        }
...
//                try
//                {
//                    rcRX ??= instanceTX.RemoteClients.FirstOrDefault(rc => (rc.Root?.OemCode.Equals(instanceRX.OEMProductCode) ?? false) && rc.Root?.ManufacturerCode == instanceRX.ESTAManufacturerCode);
//                    rcTX ??= instanceRX.RemoteClients.FirstOrDefault(rc => (rc.Root?.OemCode.Equals(instanceTX.OEMProductCode) ?? false) && rc.Root?.ManufacturerCode == instanceRX.ESTAManufacturerCode);
...
//                catch(Exception e)
//                {
//                    Assert.Fail($"Error while initializing RemoteClients: {e.Message}");
//                }
//            }
//            while (!initialized)
//            {
//                if ((rcRXPort()?.Count ?? 0) != 0 && (rcTXPort()?.Count ?? 0) != 0)
//                {
//                    initialized = true;
//                }
...
//            Assert.Multiple(() =>
//            {
//                Assert.That(rcTXPort(), Has.Count.EqualTo(1));
//                Assert.That(rcRXPort(), Has.Count.EqualTo(1));
//            });

//            var txPort = rcTXPort().First();
//            var rxPort = rcRXPort().First();
//            Assert.Multiple(() =>
//            {
